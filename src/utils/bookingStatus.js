...
export const STATUS_TONE = {
  success: { dot: 'bg-brand-gold-500', badge: 'bg-brand-gold-100 text-brand-gold-600' },
  pending: { dot: 'bg-amber-400', badge: 'bg-amber-100 text-amber-900' },
  warning: { dot: 'bg-orange-400', badge: 'bg-orange-100 text-orange-900' },
...
const ADMIN_CATEGORY_META = {
  paid_verify: {
    ...
    badge: 'bg-amber-100/90 text-amber-900 border border-amber-200/80',
    dot: 'bg-amber-500',
  ...
  unpaid: {
    ...
    badge: 'bg-orange-100/90 text-orange-900 border border-orange-200/80',
    dot: 'bg-orange-500',
  ...
  admin_unpaid: {
    ...
    badge: 'bg-indigo-100/90 text-indigo-800 border border-indigo-200/80',
    dot: 'bg-indigo-500',
  ...
  confirmed: {
    ...
    badge: 'bg-brand-gold-100/80 text-brand-gold-700',
  ...
  cancelled: {
    ...
    badge: 'bg-rose-100/80 text-rose-700 border border-rose-200/70',
    dot: 'bg-rose-400',
  ...
  completed: {
    ...
    badge: 'bg-gray-100 text-gray-600 border border-gray-200/80',
    dot: 'bg-gray-400',
    cardClass: 'opacity-75',
    paymentHighlight: false,
    canVerify: false,
