...
export default function AdminNavbar() {
  ...
  return (
    <nav
      className="sticky top-0 z-50 border-b border-brand-gold-200/60 dark:border-brand-navy-700/60"
      style={{
    ...
    >
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-2 flex-shrink-0 ml-auto">
          <button
            type="button"
            onClick={toggleTheme}
            className="w-9 h-9 flex items-center justify-center rounded-full text-gray-500 dark:text-gray-400 hover:text-brand-gold-600 hover:bg-gray-100/80 dark:hover:bg-slate-800 dark:hover:text-brand-gold-400 transition-colors"
        ...
        <button
          type="button"
          className="md:hidden p-2 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 rounded-xl hover:bg-gray-100/80 dark:hover:bg-slate-800"
          onClick={toggleTheme}
          aria-label="Toggle theme"
        >
        ...
        <button
          type="button"
          className="md:hidden p-2 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 rounded-xl hover:bg-gray-100/80 dark:hover:bg-slate-800 ml-1"
      ...
      {menuOpen && (
        <motion.div
          ...
          transition={transition.fast}
          className="md:hidden border-t border-gray-100 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md max-h-[calc(100dvh-3.5rem)] overflow-y-auto overscroll-contain"
        >
